...
proc arima data=Work._temp plots
	...
	identify var=Consumption(1 52) outcov=work.outcov0001;
	estimate p=(1 2 3 4 5) q=(1 2) method=ML outest=work.outest0001 
		outstat=work.outstat0001 outmodel=work.outmodel0001;
	forecast lead=12 back=12 alpha=0.05 id=DateTime interval=week out=stsm.ARIMAXACC nooutall;
	outlier;
	run;
quit;
